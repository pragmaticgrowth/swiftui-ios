...
CURATED = [
 ...
 {"name":"draggable-reorder","apis":["draggable","dropDestination","onDrag"],"dim":"modifiers","anchor":"draggable",
  "description":"Reorderable list via .draggable/.dropDestination with drag-and-drop.",
